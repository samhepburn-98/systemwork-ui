        ...
        if (collapse && columns && name === dropdownName) {
            ...
            template = collapse.map((item: any) => {
                ...
                return (
                    ...
                    >
                        {item.description ? (
                            <MDBox display="flex" py={0.25} fontSize="1rem" color="primary">
                                {typeof item.icon === "string" ? (
                                    <Icon color="inherit">{item.icon}</Icon>
                                ) : (
                                    <MDBox sx={{ color: "inherit" }}>{item.icon}</MDBox>
                                )}
                            ...
                            <MDBox display="flex" alignItems="center" color="primary">
    ...
    return (
        <Container>
            ...
            >
                ...
                <MDBox sx={{ color: "inherit" }} display={{ xs: "none", lg: "flex" }} m={0} p={0}>
                    {renderNavbarItems}
                </MDBox>
                {action &&
